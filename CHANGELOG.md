...
- The CI release build now uploads the Linux binaries and packaged release archives as workflow artifacts.
- Pinned `govulncheck` to v1.7.0 in CI and release workflows, because newer releases require Go 1.26.
